...
The database lives at `data/price_history.sqlite3`. It is generated at
...
| `ROMA_DATA_DIR` | `data/` | Where the SQLite file lives |
| `ROMA_STATIC_DIR` | `static/` | Where the interface is served from |
